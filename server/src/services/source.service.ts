...
// importWebSearchSource ka kaam: chat me jo web-search citation aaya tha, use permanently workspace ki library me source bana dena — taaki wo RAG index me chala jaaye aur aage ke chats me bhi retrieve ho.

// Chat me AI jab Tavily web search karta hai, wo results sirf usi answer ke liye temporary hote hain — kahin store nahi hote. User ko lage "ye link kaam ka hai, isko rakhna hai" → wo "Save to library" dabata hai, aur ye function us web result ko ek normal WEBSITE source bana ke DB me daal deta hai.
